...
public class AuthController {
    ...
    private final TestAuthController testAuthController;
    ...
    public Map<String, Object> me(Authentication authentication) {
        ...
        // 테스트 ID/PW 로그인 사용 가능 여부(심사·데모용) → 프론트가 이때만 ID/PW 폼 표시.
        res.put("testLoginEnabled", testAuthController.enabled());
